...
export const envSchema = z.object({
  ...
  BILIBILI_CLIENT_ID: optionalString,
  BILIBILI_CLIENT_SECRET: optionalString,
  ENABLE_YOUTUBE: optionalBool,
  ENABLE_BILIBILI: optionalBool,
  ENABLE_TIKTOK: optionalBool,
  ENABLE_INSTAGRAM: optionalBool,
  ENABLE_KICK: optionalBool,
  ENABLE_YOUTUBE_TRENDING: optionalBool,
  ENABLE_KICK_TRENDING: optionalBool,
  ENABLE_BILIBILI_PUBLISHING: optionalBool,
  BILIBILI_PUBLISHING_APPROVED: optionalBool,
